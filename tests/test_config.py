...
""".strip(),
            ...
            self.assertEqual(config.controls.market_buy_hold_segments[0].hold_seconds, 3.0)
            self.assertEqual(config.controls.market_buy_hold_segments[1].start, 100)
            self.assertEqual(config.controls.market_buy_hold_segments[1].function, "flat")
...
""".strip(),
            ...
            with self.assertRaisesRegex(ConfigError, "market_sell_quantity_restore_taps"):
                load_config(config_path)
