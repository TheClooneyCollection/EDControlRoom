...
- Add websocket data update handling, move panel view models to `ControlRoomDependencies.data_source`, then remove the old `/snapshot`-driven connect path.
