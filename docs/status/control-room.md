...
- Status, haul, market, and trade-route picker rendering now pass through explicit ViewModels; market/trade-route interactions use display-neutral ViewActions behind Textual adapters, and `web/haul-v1.html` is a static pure-UI Haul page prototype for the first web surface before backend wiring.
