...
- Status, haul, market, and trade-route picker rendering now pass through explicit ViewModels; trade-route picker actions are still app methods pending extraction.
