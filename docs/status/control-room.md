...
## Next
- Continue plan 0008 bottom-up by moving trade-route picker interactions behind local view actions/data sources, then turn connect UI state objects into dedicated view actions and remove remaining internal snapshot compatibility.
