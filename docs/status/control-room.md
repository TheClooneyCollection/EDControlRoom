...
- Add websocket data update handling, continue moving interactive surfaces behind view actions/data sources, then remove the old `/snapshot`-driven connect path.
