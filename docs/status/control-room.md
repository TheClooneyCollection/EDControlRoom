...
- Status, haul, market, and trade-route picker rendering now pass through explicit ViewModels; market and trade-route picker interactions are behind ViewActions.
