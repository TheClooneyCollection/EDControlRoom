...
- Remote validation now has `docs/operators/control-room-remote.md` plus both CLI and browser scratch probes for HTTP and websocket smoke checks without launching the full TUI.
